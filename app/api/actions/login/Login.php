...
class Login extends BaseAction
{
     ...
     *     @SWG\Parameter(in = "header",name = "versionName",description = "版本名称",required = true,type = "string"),
     *     @SWG\Parameter(in = "header",name = "versionCode",description = "版本编号",required = true,type = "string"),
     *     @SWG\Parameter(in = "header",name = "equipmentKey",description = "设备号",required = true,type = "string"),
